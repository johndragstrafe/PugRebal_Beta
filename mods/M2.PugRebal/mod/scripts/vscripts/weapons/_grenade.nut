...
/*
PUGREBAL:
rework frags to an impulse grenade
*/
...
bool function ShouldSetOffProximityMine( entity proximityMine, entity ent )
{
	...
	TraceResults results = TraceLine( proximityMine.GetOrigin() + < 0, 0, 4 >, ent.GetOrigin() + < 0, 0, ( ent.GetBoundingMaxs().z / 2 ) >, proximityMine, (TRACE_MASK_SHOT | CONTENTS_BLOCKLOS), TRACE_COLLISION_GROUP_NONE )
